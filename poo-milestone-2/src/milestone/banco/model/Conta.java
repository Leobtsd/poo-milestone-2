...
public class Conta {
    ...
    public void depositar(BigDecimal valor) {
        ...
        if (status && valor.compareTo(BigDecimal.ZERO) > 0 && valor.compareTo(saldo.negate()) < 0) {
    ...
    public void transferir(Conta destino, BigDecimal valor) {
        ...
        if (status && destino.status && valor.compareTo(BigDecimal.ZERO) > 0 && valor.compareTo(saldo.negate()) < 0) {
            saldo = saldo.subtract(valor);
